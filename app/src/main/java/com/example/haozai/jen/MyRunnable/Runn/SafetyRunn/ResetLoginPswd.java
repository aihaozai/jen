...
public class ResetLoginPswd {
    private static String phone,pswd,ERROR,result;
    private static Reset reset;
    public void resetLogon(Reset reset){
        this.reset = reset;
    }
    ...
    private static class MyRunnable implements Runnable {
        ...
        public void run() {
            ...
            try {
                String resultWeb = WebService.fortwo(phone,pswd);
