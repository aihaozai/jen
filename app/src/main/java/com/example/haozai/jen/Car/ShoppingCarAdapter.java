...
public class ShoppingCarAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvCommodityAttr.setText(shoppingCartBean.getShoppingPress());
        ...
        holder.ivAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                modifyCountInterface.doIncrease(position, holder.tvCommodityShowNum, holder.ckOneChose.isChecked(),shoppingCartBean.getImageUrl());//暴露增加接口
            }
        });
        //删减按钮
        holder.ivSub.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                modifyCountInterface.doDecrease(position, holder.tvCommodityShowNum, holder.ckOneChose.isChecked(),shoppingCartBean.getImageUrl());//暴露删减接口
            }
        });
        //删除弹窗
            ...
            public void onClick(View v) {
                ...
                alert.setButton(DialogInterface.BUTTON_POSITIVE, "确定",
                        new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                modifyCountInterface.childDelete(position,shoppingCartBean.getImageUrl());//删除 目前只是从item中移除
        ...
        //判断是否在编辑状态下
        if (isShow) {
            holder.tvCommodityName.setVisibility(VISIBLE);
            holder.rlEdit.setVisibility(View.GONE);
            holder.tvCommodityNum.setVisibility(VISIBLE);
            holder.tvCommodityDelete.setVisibility(View.GONE);
        } else {
            holder.tvCommodityName.setVisibility(VISIBLE);
            holder.rlEdit.setVisibility(VISIBLE);
            holder.tvCommodityNum.setVisibility(VISIBLE);
            holder.tvCommodityDelete.setVisibility(VISIBLE);
        }
    ...
    //初始化控件
    class ViewHolder {
        ImageView ivShowPic,tvCommodityDelete,position_edit;
    ...
    public interface ModifyCountInterface {
         ...
         */
        void doIncrease(int position, View showCountView, boolean isChecked,String url);
         ...
         * @param isChecked     子元素选中与否
         */
        void doDecrease(int position, View showCountView, boolean isChecked,String url);
         ...
         * @param position
         */
        void childDelete(int position,String url);
    }
}
