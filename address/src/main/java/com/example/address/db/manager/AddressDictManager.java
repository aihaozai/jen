package com.example.address.db.manager;
...
import com.example.address.db.AssetsDatabaseManager;
import com.example.address.db.TableField;

import java.util.ArrayList;
import java.util.List;

import static com.example.address.db.TableField.ADDRESS_DICT_FIELD_CODE;
import static com.example.address.db.TableField.ADDRESS_DICT_FIELD_ID;
import static com.example.address.db.TableField.ADDRESS_DICT_FIELD_PARENTID;
